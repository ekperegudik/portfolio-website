...
export default function LiquidEther({
  ...
  const effectiveColors = color0 && color1 && color2 ? [color0, color1, color2] : colors;
...
`;
    ...
    class Simulation {
      ...
      update() {
        ...
        const pressure = this.poisson.update({ iterations: this.options.iterations_poisson }) as THREE.WebGLRenderTarget | null;
