...
const experience = [
  {
    ...
    company: (
      <a href="https://atom.auto/" className="text-primary hover:underline">
        ATOM
      </a>
    ),
  ...
  },
  {
    ...
    company: (
      <a href="https://nedra.digital/" className="text-primary hover:underline">
        Nedra Digital
      </a>
    ),
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:gap-16">
            ...
            <RevealOnScroll delay={240} className="flex-1">
              ...
              <p className="mb-4 leading-[1.4rem] text-muted-foreground">
                Я дизайнер UX, UI, продуктов, высоконагруженных интерфейсов, а
                также ящичка со специями на своей кухне. Структурирую и
                упорядочиваю всё, до чего могу дотянуться.
              </p>
            ...
            {approach.map((item, index) => (
              <RevealOnScroll key={item.title} delay={220 + index * 120}>
                <div className="rounded-xl border border-white/0 bg-white/2 p-6 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_10px_30px_rgba(0,0,0,0.10)]">
                  ...
                  <p className="text-sm leading-[1.4rem] text-muted-foreground">
                    {item.description}
                  </p>
                </div>
              </RevealOnScroll>
          ...
          <RevealOnScroll delay={240}>
            <div className="border-l border-white/10 pl-6">
              ...
              <p className="text-muted-foreground">
                ...
                по истории скандинавского дизайна с интерактивными 3D-моделями
                легендарных изделий.
              </p>
            </div>
          </RevealOnScroll>
